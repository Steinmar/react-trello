...
export const enum BoardDetailsStateActionTypes {
  ...
  DELETE_COLUMN_REQUEST = '@@BoardDetails/DELETE_COLUMN_REQUEST',
  DELETE_COLUMN_SUCCESS = '@@BoardDetails/DELETE_COLUMN_SUCCESS',
  DELETE_COLUMN_ERROR = '@@BoardDetails/DELETE_COLUMN_ERROR',
